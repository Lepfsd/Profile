...
@section('content-header')
    <h1>
        {{ trans('profile::profiles.title.profiles') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li class="active">{{ trans('profile::profiles.title.profiles') }}</li>
    </ol>
@stop
            ...
            <div class="row">
                <div class="btn-group pull-right" style="margin: 0 15px 15px 0;">
                    <a href="{{ route('admin.profile.profile.create') }}" class="btn btn-primary btn-flat" style="padding: 4px 10px;">
                        <i class="fa fa-pencil"></i> {{ trans('profile::profiles.button.create profile') }}
                    </a>
                </div>
            </div>
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <table class="data-table table table-bordered table-hover">
                        ...
                        <tr>
                            <td>
                                <a href="{{ route('admin.profile.profile.edit', [$profile->id]) }}">
                                    {{ $profile->created_at }}
                                </a>
                            </td>
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('admin.profile.profile.edit', [$profile->id]) }}" class="btn btn-default btn-flat"><i class="glyphicon glyphicon-pencil"></i></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    {!! Form::open(['route' => ['admin.profile.profile.destroy', $profile->id], 'method' => 'delete', 'class' => 'pull-left']) !!}
